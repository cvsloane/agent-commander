...
- Current phase: W1-R4 live laptop acceptance
- Overall state: running
- Last updated: 2026-07-22T15:01:57-04:00
- Current accepted baseline: production `56644694c50e8ccca33596556efe0e3f072853b5`
- Current candidate: W1-R4 deployed at `56644694c50e8ccca33596556efe0e3f072853b5`; both hosts remain on agentd `9e8eaf3` with SHA-256 `d6e4273af70136fe98f678bc4b1efad5d7cee86e6e738dbf8ae172106621dc7b`
...
|---|---|---|---|---|---|---|
| W1 — Shared terminal repair | Human Owner check | deployed | PR #101 merge `5664469`; Coolify `q128diofv1kzrfntjn0ic38p`; agentd `9e8eaf3` | Full CI green; fresh re-review pass; exact-source containers running; public health `ok` with two agents | Live laptop interaction | Chris hard-refreshes and rechecks scrollback plus passive attention behavior |
...
| W1 live laptop | waiting | W1-R4 is live with DOM-rendered scrollback and passive waiting-input terminal overlays removed | Human Owner | Hard refresh, then repeat scrollback and attention check |
...
1. Chris hard-refreshes production and rechecks scrollback readability plus the absence of passive waiting-input overlays.
