...
- Last updated: 2026-07-22T14:53:58-04:00
- Current accepted baseline: production `2b7b239656bfc8a1d7a62ec18f65e76cd7e2c559`
- Current candidate: W1-R4 `d73cd5c3aebcb910c32cf0ec92d56e1bb287d860` in PR #101; both hosts remain on agentd `9e8eaf3` with SHA-256 `d6e4273af70136fe98f678bc4b1efad5d7cee86e6e738dbf8ae172106621dc7b`
...
|---|---|---|---|---|---|---|
| W1 — Shared terminal repair | AI Lead | PR open | PR #101 at W1-R4 `d73cd5c`; production remains PR #100 merge `2b7b239` | Existing 120-line scrollback journey passes on the DOM renderer; 3/3 waiting-input smoke paths, 2/2 explicit approval journeys, explicit-error boundary, and dashboard typecheck pass | CI and rollout | Merge PR #101 and deploy |
